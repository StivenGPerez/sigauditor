function top_20_cargos_moc(inter_id){
...
var options = {
    ...
    title: {
        text: '<strong>TOP 20 Cargos más empleados por MOC</strong>',
        align:'left'
    },
    subtitle: {
        text: null
    ...
    //var id=$("#estacion_id").attr("value");
        ...
        $.getJSON(baseurl+'index.php/con_graficas/top_20_cargos_moc',{'inter_id': inter_id}, function(json){
