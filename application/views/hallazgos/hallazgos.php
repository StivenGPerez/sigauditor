<section class="container sombra">
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
	        ...
	        <span class="glyphicon glyphicon-search"></span> Hallazgos</h3>
	    </div>
	...
	<div class="panel-footer">
		<a href="<?php echo base_url(); ?>index.php/inicio/principal" class="btn btn-danger btn-block"><strong>Volver</strong></a>
	</div>
